...
Kirigami.PageRow {
    ...
    Sonnet.SpellcheckHighlighter {
        ...
        readonly property Item field: tryit(() => (rootWindow.activeFocusItem instanceof TextEdit) && !rootWindow.activeFocusItem.readOnly ? rootWindow.activeFocusItem : null, null)
